...
import { LayoutDashboard, Users, Hash, LogOut, Gamepad2, Gift, MessageSquare, Trophy, Star, Calendar, Swords, ShieldAlert } from 'lucide-react'
...
const navigation = [
    ...
    { name: 'Eventos', href: '/stats/events', icon: Calendar },
            ...
            <div className="p-6 border-b border-slate-700/50 space-y-4">
                <div className="flex items-center justify-between">
                    ...
                    {onClose && (
                        <button
                            onClick={onClose}
                            className="p-2 text-slate-400 hover:text-white hover:bg-slate-800/50 rounded-lg md:hidden"
                        >
